...
const FeaturedProducts = ({ featureProducts }) => {
  ...
  const isEndDisabled = currentIndex >= featureProducts.length - itemPerPage;
        ...
        <div className=" relative">
          <div className=" overflow-hidden">
            <div
              ...
              style={{
                transform: ` translateX(-${currentIndex * (100 / itemPerPage)}%)`,
              }}
            >
